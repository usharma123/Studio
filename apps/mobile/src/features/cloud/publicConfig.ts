...
export interface CloudPublicConfig {
  ...
  readonly observability: {
    ...
    readonly tracesAuthorization: string | null;
  };
}
...
export function resolveCloudPublicConfig(extra: ExpoExtra = Constants.expoConfig?.extra) {
  return {
    ...
    observability: {
      ...
      tracesAuthorization: trimNonEmpty(extra?.observability?.tracesAuthorization),
    },
...
export function hasTracingPublicConfig(
  ...
  return Boolean(
    ...
    config.observability.tracesAuthorization,
  );
}
