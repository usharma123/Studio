...
import { DiffTokenText, ReviewChangeBar } from "./reviewDiffRendering";
import { changeTone, REVIEW_MONO_FONT_FAMILY } from "./reviewDiffStyle";
import {
...
export function ReviewCommentComposerSheet(props: ReviewCommentComposerSheetProps) {
  ...
  const [highlightedLinesById, dispatchHighlightedLines] = useReducer(
    (
      _: Record<string, ReadonlyArray<ReviewHighlightedToken>>,
      next: Record<string, ReadonlyArray<ReviewHighlightedToken>>,
    ) => next,
    {},
  );
