...
export const APP_BASE_NAME = injectedDesktopAppBranding?.baseName ?? "Studio";
...
export const DESKTOP_DEVELOPMENT_PROFILE = injectedDesktopAppBranding?.developmentProfile ?? null;
