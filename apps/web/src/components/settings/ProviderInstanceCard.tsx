...
import { ProviderInstanceCardView } from "./ProviderInstanceCardView";
 ...
 */
function useProviderInstanceCardController({
  instanceId,
  instance,
  driverOption,
  liveProvider,
...
export type ProviderInstanceCardController = ReturnType<typeof useProviderInstanceCardController>;
export function ProviderInstanceCard({
  ...
  const controller = useProviderInstanceCardController({
    instanceId,
    instance,
    driverOption,
    liveProvider,
  ...
  return <ProviderInstanceCardView controller={controller} />;
}
