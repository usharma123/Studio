...
function PreviewAutomationHost(props: { readonly environmentId: EnvironmentId }) {
  ...
  const initialAutomationHost = {
    clientId: automationClientId,
    environmentId,
    supportedOperations: [...PREVIEW_AUTOMATION_OPERATIONS],
  } as PreviewAutomationHostState;
  ...
  const handleRequest = async (request: PreviewAutomationRequest): Promise<unknown> => {
  ...
  const automationRequestConsumerAtom = createPreviewAutomationRequestConsumerAtom({
