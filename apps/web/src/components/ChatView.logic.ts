...
/** Compares identity lists as sets so freshly derived arrays do not trigger state churn. */
export function haveSameIds(left: ReadonlyArray<string>, right: ReadonlyArray<string>): boolean {
