...
function $setSelectionRangeAtComposerOffsets(startOffset: number, endOffset: number): void {
  ...
  const anchorRemainingRef = {
    value: boundedStart,
  };
  const focusRemainingRef = {
    value: boundedEnd,
  };
...
function ComposerSurroundSelectionPlugin(props: {
  ...
  const [skillMetadataRef] = useState(() => ({ current: skillMetadataByName(props.skills) }));
...
function ComposerPromptEditorInner({
  ...
  const [skillMetadataRef] = useState(() => ({ current: skillMetadataByName(skills) }));
...
export function ComposerPromptEditor({
  ...
  const [initialSkillMetadataRef] = useState(() => ({ current: skillMetadataByName(skills) }));
  const initialConfig = {
