...
import { formatPendingPrimaryActionLabel } from "./ComposerPrimaryActions.logic";
...
export const ComposerPrimaryActions = function ComposerPrimaryActions({
  layout,
  state,
  ...
  const { compact, preserveComposerFocusOnPointerDown = false } = layout;
  const {
    pendingAction,
    isRunning,
