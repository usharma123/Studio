...
const configuredRelayTracingPublicIngest = repoEnv.VITE_RELAY_OTLP_TRACES_TOKEN?.trim() || "";
...
export default defineConfig(() => {
  return {
    ...
    define: {
      ...
      "import.meta.env.VITE_RELAY_OTLP_TRACES_PUBLIC_INGEST": JSON.stringify(
        configuredRelayTracingPublicIngest,
      ),
