...
export const QA_ASSISTANT_DETACH_CHANNEL = "desktop:qa-assistant-detach";
export const QA_ASSISTANT_CLOSE_CHANNEL = "desktop:qa-assistant-close";
export const QA_ASSISTANT_REATTACHED_CHANNEL = "desktop:qa-assistant-reattached";
