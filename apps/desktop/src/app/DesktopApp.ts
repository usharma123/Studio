...
const startup = Effect.gen(function* () {
  ...
  // Electron stores cookies and network caches under sessionData. Keep it aligned
  // with the selected profile before ready so Chromium's network service receives
  // access to the same profile root as the renderer sessions it serves.
