...
import Migration0033 from "./Migrations/033_QaWorkflow.ts";
import Migration0034 from "./Migrations/034_QaStageRouting.ts";
import Migration0035 from "./Migrations/035_QaRequirementsTraceability.ts";
import Migration0036 from "./Migrations/036_QaStrategyWorkflow.ts";
import Migration0037 from "./Migrations/037_QaScenarioTestCasePlans.ts";
import Migration0038 from "./Migrations/038_QaScriptsReadiness.ts";
import Migration0039 from "./Migrations/039_QaDurableIngestion.ts";
import Migration0040 from "./Migrations/040_QaRequirementEvidence.ts";
...
export const migrationEntries = [
  ...
  [33, "QaWorkflow", Migration0033],
  [34, "QaStageRouting", Migration0034],
  [35, "QaRequirementsTraceability", Migration0035],
  [36, "QaStrategyWorkflow", Migration0036],
  [37, "QaScenarioTestCasePlans", Migration0037],
  [38, "QaScriptsReadiness", Migration0038],
  [39, "QaDurableIngestion", Migration0039],
  [40, "QaRequirementEvidence", Migration0040],
