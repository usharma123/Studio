...
import { QaToolkitHandlersLive } from "./toolkits/qa/handlers.ts";
import { QaToolkit } from "./toolkits/qa/tools.ts";
...
const QaToolkitRegistrationLive = McpServer.toolkit(QaToolkit).pipe(
  Layer.provide(QaToolkitHandlersLive),
);
...
export const layer = Layer.mergeAll(PreviewToolkitRegistrationLive, QaToolkitRegistrationLive).pipe(
