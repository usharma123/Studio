...
export const QA_CODEX_PERMISSION_PROFILE = "t3_qa_release";
export const QA_CODEX_APP_SERVER_ARGS = [
  "-c",
  `default_permissions="${QA_CODEX_PERMISSION_PROFILE}"`,
  "-c",
  `permissions.${QA_CODEX_PERMISSION_PROFILE}.description="QA release evidence only"`,
  "-c",
  `permissions.${QA_CODEX_PERMISSION_PROFILE}.filesystem.":minimal"="read"`,
  "-c",
  `permissions.${QA_CODEX_PERMISSION_PROFILE}.filesystem.":workspace_roots"."."="deny"`,
  "-c",
