...
import { DesktopDevelopmentProfile } from "./desktopBootstrap.ts";
...
export type DesktopWindowChromeState = typeof DesktopWindowChromeStateSchema.Type;

export const DesktopQaAssistantWindowInputSchema = Schema.Struct({
  environmentId: EnvironmentId,
  threadId: ThreadId,
  projectTitle: Schema.String,
  releaseTitle: Schema.String,
});
export type DesktopQaAssistantWindowInput = typeof DesktopQaAssistantWindowInputSchema.Type;
...
export interface DesktopAppBranding {
  ...
  displayName: string;
  developmentProfile?: DesktopDevelopmentProfile;
}
...
export interface DesktopBridge {
  ...
  onWindowChromeStateChange?: (listener: (state: DesktopWindowChromeState) => void) => () => void;
  detachQaAssistant?: (input: DesktopQaAssistantWindowInput) => Promise<void>;
  closeQaAssistant?: () => Promise<void>;
  onQaAssistantReattached?: (
    listener: (input: DesktopQaAssistantWindowInput) => void,
  ) => () => void;
