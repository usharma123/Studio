...
export const AuthQaReadScope = "qa:read" as const;
export const AuthQaMakeScope = "qa:make" as const;
export const AuthQaApproveScope = "qa:approve" as const;
export const AuthQaChatScope = "qa:chat" as const;
...
/** Trusted local desktop grants. QA profiles intentionally exclude generic workspace access. */
export const AuthQaRootScopes = [
...
export const AuthQaMakerScopes = [
  AuthQaReadScope,
  AuthQaMakeScope,
  AuthQaChatScope,
  AuthPreviewOperateScope,
] as const;
export const AuthQaApproverScopes = [
  AuthQaReadScope,
  AuthQaApproveScope,
  AuthQaChatScope,
  AuthPreviewOperateScope,
