  ...
  switch (method) {
    ...
    case "skills/list": {
      ...
      pendingUserInputRequestId =
        process.env.CODEX_APP_SERVER_TEST_KNOWN_UNHANDLED_REQUEST === "1"
          ? sendRequest("item/permissions/requestApproval", { sentinel: true })
          : sendRequest("item/tool/requestUserInput", {
